...
public class CommandsParser {
	...
	/*
		...
		String r5 = "^(\\s*)(DROP\\s* TABLE|CREATE\\s* DATABASE|DROP\\s* DATABASE)(\\s+)(\\b.+\\b)(\\s*)$"; // done0String r6 = "^(\\s*)(SELECT)(\\s+)(\\b.+\\b)(\\s+)(FROM)(\\s+)(\\b.+\\b)(\\s+)(WHERE)(\\s+)(\\b.+\\b)"; // done-2
		...
		Pattern p2 = Pattern.compile(r2, Pattern.CASE_INSENSITIVE);
